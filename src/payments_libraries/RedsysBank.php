...
class RedsysBank
{
     ...
     * Set Class Submit
     *
     * @param string $value Este parámetro se utilizará para customizar el estilo inline del elemento input type submit.
     *
     * @return $this
     */
    public function setValueSubmit($value = 'Enviar')
    {
     ...
     * @return $this
     */
    public function setStyleSubmit($value = '')
    {
        $this->_setStyleSubmit = $value;
     ...
     * Set Class Submit
     *
     * @param string $value Este parámetro se utilizará para customizar la clase del boton en caso de que lo uses en un estilo como boostrap, bulma, etc.
     *
     * @return $this
     */
    public function setClassSubmit($value = '')
    {
        $this->_setClassSubmit = $value;
